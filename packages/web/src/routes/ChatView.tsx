...
export function ChatView() {
      ...
      <div className="flex flex-col h-full bg-kai-bg">
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="max-w-md w-full bg-kai-bg-surface border border-kai-border rounded-xl p-8 text-center">
            ...
            <p className="text-kai-text-secondary mb-6">{error.message}</p>
  ...
  return (
    <div className="flex flex-col h-full bg-kai-bg">
      {/* Header */}
      <div className="flex items-center justify-end px-4 py-2 border-b border-kai-border bg-kai-bg">
...
function AttachmentPreview({ attachment, onRemove }: { attachment: Attachment; onRemove: () => void }) {
  ...
  return (
    <div className="flex items-center gap-2 px-3 py-1.5 bg-kai-bg-surface border border-kai-border rounded-lg text-sm group">
      {isImage ? (
...
function WelcomeScreen({ onSelect }: { onSelect: (text: string) => void }) {
  ...
  return (
    <div className="text-center py-12">
      ...
      <p className="text-kai-text-secondary mb-8">What would you like to work on today?</p>
