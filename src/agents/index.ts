...
// Templates - stub implementation (file removed, feature deprecated)
export const registerTemplate = () => { throw new Error("Templates feature removed"); };
export const getTemplate = () => undefined;
export const listTemplates = () => [];
export const spawnFromTemplate = async () => { throw new Error("Templates feature removed - use createAgent instead"); };
export type AgentTemplate = never;
